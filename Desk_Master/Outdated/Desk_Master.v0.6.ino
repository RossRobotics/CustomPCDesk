...
//  6-1-22
//    -Added MP3 Trigger for thunderstorm audio (untested)
//  6-2-22
...
#define LOGO_COLORHUE 2
//CIRCUIT
#define CIRCUIT_COLORHUE 3
#define CIRCUIT_SWIPESPEED 4
#define CIRCUIT_ANIMATIONSPEED 5
...
//************** Glass Top Control  *****************************//
enum {OPEN, CLOSED, OPENING, CLOSING, ERR};
byte get_status(){
