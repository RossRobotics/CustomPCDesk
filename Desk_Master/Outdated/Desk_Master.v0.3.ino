...
#pragma pack(push, 1)
uint8_t RemoteXY_CONF[] =   // 1142 bytes
  { 255,34,0,4,0,111,4,16,25,4,130,1,1,23,36,34,3,137,130,0,
  30,23,36,34,2,180,130,0,0,23,30,34,2,180,130,1,23,6,24,11,
  ...
  80,111,119,101,114,0,131,1,20,58,19,4,1,14,24,77,97,105,110,0,
  131,0,42,58,18,4,2,166,24,69,102,102,101,99,116,115,0,10,117,30,
  36,13,6,1,4,34,31,32,32,32,67,97,115,101,32,32,32,0,31,4,
  0,35,27,5,29,2,27,25,4,0,42,27,5,29,2,27,25,4,0,49,
  27,5,29,2,27,25,129,0,40,23,16,3,2,26,66,114,105,103,104,116,
  110,101,115,115,0,4,0,56,27,5,29,2,27,25,129,0,35,26,5,2,
  2,26,76,111,103,111,0,129,0,42,26,6,2,2,26,87,97,116,101,114,
  0,129,0,50,26,4,2,2,26,73,110,102,121,0,129,0,57,26,3,2,
  2,26,77,66,0,130,0,66,23,34,34,2,180,129,0,75,23,18,3,2,
  26,69,102,102,101,99,116,32,83,112,101,101,100,0,4,0,70,27,5,29,
  2,87,25,4,0,77,27,5,29,2,87,25,4,0,84,27,5,29,2,87,
  25,129,0,71,26,3,2,2,26,77,66,0,129,0,77,26,5,2,2,26,
  76,111,103,111,0,129,0,84,26,6,2,2,26,87,97,116,101,114,0,4,
  0,91,27,5,29,2,87,25,129,0,92,26,4,2,2,26,88,116,114,97,
  0,1,1,46,37,8,4,1,28,227,226,150,186,0,131,0,62,58,18,4,
  3,137,24,67,111,108,111,114,115,0,129,0,11,23,15,3,3,26,67,111,
  108,111,114,32,72,117,101,0,4,0,6,27,5,29,3,158,25,4,0,13,
  27,5,29,3,158,25,4,0,20,27,5,29,3,158,25,129,0,14,26,3,
  2,3,26,77,66,0,129,0,6,26,4,2,3,26,76,111,103,111,0,129,
  0,20,26,4,2,3,26,87,97,116,101,114,0,4,0,27,27,5,29,3,
  158,25,129,0,27,26,4,2,3,26,67,97,115,101,0,10,117,68,30,21,
  4,1,4,34,31,32,32,32,32,32,32,32,83,116,111,114,109,32,32,32,
  32,32,32,32,0,31,129,0,68,24,21,3,1,26,83,112,101,99,105,97,
  108,32,69,102,102,101,99,116,115,0,129,0,12,23,7,3,2,26,67,111,
  108,111,114,0,129,0,5,26,5,2,2,26,76,111,103,111,0,4,0,5,
  27,5,29,2,27,25,10,117,30,43,13,6,1,4,34,31,32,32,67,105,
  114,99,117,105,116,32,32,0,31,1,1,46,44,8,4,1,28,9,226,150,
  186,0 }; 
...
struct {
  ...
  int8_t logo_Color; // =0..100 slider position 
...
#define PIN_PUSHSWITCH_WATER 47
...
#define PIN_INFINITYPATTERNSELECT 40
#define PIN_PUSHSWITCH_CASELED 32
#define PIN_CASEPATTERNSELECT 36
#define PIN_BUTTONNC 50
#define LOGO_COLORHUE A2
#define PIN_PUSHSWITCH_CIRCUIT 32
#define PIN_CIRCUITPATTERNSELECT 36

//THUNDERSTORM EFFECT
int stormEnable[] = {14,13,12,11,10};
#define PIN_PUSHSWITCH_STORM 53
#define PIN_STORM_AUDIO 52
...
void setup(){
  RemoteXY_Init ();
    ...
    for (int stormpins=10; stormpins<15; stormpins++) {
...
void loop() {
  ...
  digitalWrite(PIN_CIRCUITPATTERNSELECT, (RemoteXY.circuitPatternSelect==0)?HIGH:HIGH);
