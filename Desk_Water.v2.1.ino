...
void loop() {
  ...
  switch (selectedEffect) {
    ...
    case 0  : {
        ...
        CylonBounce(0xff, 0x00, 0x00, 1, 40, 50);
        break;
      }

    case 1  : {
        // CylonBounce - Color (red, green, blue), eye size, speed delay, end pause
        CylonBounce(0x00, 0x00, 0xff, 1, 40, 50);
        break;
      }

    case 2  : {
        // CylonBounce - Color (red, green, blue), eye size, speed delay, end pause
        CylonBounce(0x00, 0xff, 0x00, 1, 40, 50);
        break;
      }

    case 3  : {
        // CylonBounce - Color (red, green, blue), eye size, speed delay, end pause
        CylonBounce(0xff, 0x00, 0x00, 1, 50, 70);
        break;
      }

    case 4  : {
        // NewKITT - Color (red, green, blue), eye size, speed delay, end pause
        NewKITT(0xff, 0x00, 0x00, 2, 60, 100);
        break;
      }

    case 5  : {
        // NewKITT - Color (red, green, blue), eye size, speed delay, end pause
        NewKITT(0x00, 0x00, 0xff, 2, 60, 100);
        break;
      }

    case 6  : {
        // Twinkle - Color (red, green, blue), count, speed delay, only one twinkle (true/false)
        Twinkle(0x00, 0xff, 0xff, 2, 100, false);
        break;
      }

    case 7  : {
        // TwinkleRandom - twinkle count, speed delay, only one (true/false)
        TwinkleRandom(10, 80, false);
        break;
      }
...
void cometEffect()
{
  ...
  if (index >= NUM_LEDS - 1) {
    leds[index] = leds[index - 1];  // take last index=0; off for a 1 shot comet (1 pass)
    index = 0;
  }
  leds[index] = CHSV(145, 255, GLOBAL_BRIGHTNESS);                //trail

  //  leds[index] = CHSV(gHue*10,random16(120,160),random16((GLOBAL_BRIGHTNESS/3),(GLOBAL_BRIGHTNESS)));          //trail RAINBOW++
  fadeLEDs(35);
  FastLED.delay(10);
}
...
void fireStarter() {
  ...
  ledh[index] = 148;                    // can be used to choose color
  ...
  //leds[index] = (ledh[index],0,0);
  leds[index] = CRGB(0, 195, 255);
  //leds[index] = CHSV (0,0, 190);  //dot  WHITE TO PALE YELLOW DOT
