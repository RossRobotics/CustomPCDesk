...
#define MAT_PIN 3           /* Data for matrix on D3 on ESP8266 */
...
#define BRIGHT 150          /* brightness; min 0 - 255 max -- high brightness requires a hefty power supply! Start low! */
#define FPS 90              /* Refresh rate */
#define colorPin A1
...
const uint8_t maxflare = 4;     /* max number of simultaneous flares */
